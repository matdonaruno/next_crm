    ...
    <div className="header w-full min-h-screen relative">
      ...
      <div className="inner-header flex">
        <center>
          ...
          <div className="mt-20">
            <Link href="/login" className="px-6 py-3 text-lg font-medium border-2 border-white text-white rounded-md hover:bg-white hover:bg-opacity-20 transition-all font-sans" role="button">
            &nbsp;Login&nbsp;
            </Link>
          </div>
        </center>
